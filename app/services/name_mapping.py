...
_INGREDIENT_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "egg": ("달걀", "계란"),
    "eggplant": ("가지",),
    "fish": ("생선", "생선살", "흰살생선", "대구", "동태", "광어"),
    "garlic": ("마늘", "다진마늘", "다진 마늘", "통마늘"),
    "leek": ("대파", "파", "쪽파", "실파", "green_onion", "green onion", "scallion", "spring onion"),
    "lettuce": ("상추", "청상추", "로메인"),
    "milk": ("우유",),
    "mushroom": ("버섯", "새송이", "새송이버섯", "표고", "표고버섯", "양송이", "양송이버섯", "느타리", "느타리버섯"),
    "onion": ("양파",),
    "pepper": ("파프리카", "빨간파프리카", "노란파프리카", "빨간 파프리카", "노란 파프리카"),
    "pork": ("돼지고기", "돼지", "목살", "삼겹살", "앞다리살"),
    "potato": ("감자",),
    "sausage": ("소시지", "소세지", "비엔나", "비엔나소시지", "프랑크"),
    "tomato": ("토마토", "방울토마토"),
