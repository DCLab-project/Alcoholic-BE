...
class Recipe(Base):
    ...
    pantry_item_details_text: Mapped[str] = mapped_column(Text, default="")
    recipe_steps_text: Mapped[str] = mapped_column(Text, default="")
    pairing_flavor_logic: Mapped[str] = mapped_column(Text, default="")
    pairing_ingredient_logic: Mapped[str] = mapped_column(Text, default="")
    pairing_why_this_liquor: Mapped[str] = mapped_column(Text, default="")
...
class RecipeIngredient(Base):
    ...
    variant_detail: Mapped[str] = mapped_column(Text, default="")
